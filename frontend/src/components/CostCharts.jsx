...
export default function CostCharts({ tasks }) {
    ...
    if (active && payload && payload.length) {
      return (
        <Box sx={{ bgcolor: '#111a22', border: '1px solid #161a22', p: 1.5, borderRadius: 1.5 }}>
          ...
          <Typography variant="body2" sx={{ fontWeight: 'bold', color: '#00ff9d', my: 0.5 }}>
          ...
          <AreaChart data={data} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
            <defs>
              <linearGradient id="colorCost" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="95%" stopColor="#00ff9d" stopOpacity={0.01}/>
              </linearGradient>
            </defs>
            ...
            <Area type="monotone" dataKey="cost" stroke="#00ff9d" strokeWidth={2} fillOpacity={1} fill="url(#colorCost)" />
          </AreaChart>
        </ResponsiveContainer>
      )}
    </Box>
